// CDINOSAUR.cpp — Ancient map
// Sprite: Ancientdinasour_Obstacle.png
#include "CDINASOUR.h"
#include "ObstacleHelper.h"

CDINOSAUR::CDINOSAUR(float startX, float startY, float spd, bool moveRight)
    : CANIMAL(startX, startY, spd, moveRight)
{
    if (!texture.loadFromFile("Obstacles/Ancientdinasour_Obstacle.png")) return;
    ...
    frameTime = 0.14f;  // Khủng long: chạy chậm rãi, nặng nề
